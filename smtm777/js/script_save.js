...
$(document).ready(function() {
    ...
    $('input.insertCode').on('click focus', function(e) {
         ...
         //      top = $this.offset().top;
         //      if($('.inputBox').length){
         //           left = $('.inputBox').offset().left + $('.inputBox').innerWidth();
         //      }else{
         //           console.log('.inputBox 없음')
         //      }
         // }else{
         //      console.log("input.insertCode 없음")
         // }
         // console.log(top, left)
         // $('.popupLayer.inputmsg').css({'top':top, 'left':left + 40}).show();
         // $('.inputmsg').css({'max-height':'340px', 'overflow-y': 'visible'});
         $('.inputmsg').css({'max-height':'340px'});
         commonjs.eventClick(e);
    });

    $('.inputmsg .btnclose').on('click', function(e) {
         // $('.inputmsg').css({'max-height':'0', 'overflow-y': 'hidden'});
    ...
    $('.guidebtn.start').on('click', function(e) {
         if ($('input.insertCode').val().length == 0) {
              ...
              // if (sendData == '4593-9872-5484' || sendData == '0000-0000-0000') {
              //      //마스터 코드 (DB에 저장되지 않음)
              //      console.log("마스터코드 입력: " + sendData);
              // } else {
              //
              //      if (sendData == '4593-9872-5484' || sendData == '1807-2249-2084' || sendData == '0000-0000-0000') {
              //           //마스터 코드 (DB에 저장되지 않음)
              //           console.log("마스터코드 입력. valid =" + sendData);
              //           // location.href = pageLink.main + '?code='+sendData;
              //      } else {
              ...
              //                isValid = vals.result;
              //                console.log(isValid);
              //                // vals.result = 'valid' 유효한 코드 (응모가능)
              //                // vals.result = 'invalid' 유효하지 않은 코드
              //                // vals.result = 'used' 이미 사용된 코드
              //                // vals.result = 'endtoday' 금일 100개 마감
              //                if (vals.result == "endtoday") {
              //                     $('.popupLayer.line2').find('.text').html('금일 SMTM 777 신청이 마감되었습니다.<br>내일 다시 신청해주세요!');
              //                     $('.popupLayer.line2').show();
              //                } else if (vals.result == "invalid") {
              //                     // $('.popupLayer.line2').find('.text').html('코드번호가 맞지 않습니다.<br>SMTM 777 구입하고 질레트 코드 받아보세요!');
              //                     $('.popupLayer.line2').show();
              //                } else if (vals.result == "used") {
              //                     $('.popupLayer.line2').find('h2').html('이미 사용된 코드입니다.');
              //                     $('.popupLayer.line2').find('.text').html('SMTM 777 구입하고 질레트 코드를<br class="mobilebr"> 받아보세요!');
              //                     $('.popupLayer.line2').show();
              //                } else if (vals.result == "valid") {
              //                     console.log("rank = " + vals.result2)
              //                     rank = vals.result2;
              //
              //                     if (rank == 0) {
              //                          //미당첨
              ...
              //                                                        // document.getElementById('delivery_address2').value = data.addressEnglish;
              //                                                   },
              //                                                   width: '100%',
              //                                                   height: '100%',
              //                                                   maxSuggestItems: 5
